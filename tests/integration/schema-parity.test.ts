...
const COLUMNS: Record<string, string[]> = {
  ...
  programs: ["id", "status", "translation_status", "published_at", "created_at", "updated_at", "created_by", "updated_by", "slug_ar", "slug_en", "key", "title_ar", "title_en", "tagline_ar", "tagline_en", "accent_token", "introduction_ar", "introduction_en", "rationale_ar", "rationale_en", "strategic_objective_ar", "strategic_objective_en", "specific_objectives", "key_interventions", "sustainability_ar", "sustainability_en", "impact_statement_ar", "impact_statement_en", "eligibility_ar", "eligibility_en", "how_to_access_ar", "how_to_access_en", "target_groups", "hero_media_id", "display_order", "seo_title_ar", "seo_title_en", "seo_description_ar", "seo_description_en", "og_media_id", "no_index"],
